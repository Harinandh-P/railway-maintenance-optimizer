  ...
  return (
    <div>
      <div style={{ marginBottom: '32px' }}>
        <h1 style={{ fontSize: '1.75rem', fontWeight: 800, color: '#DFE2EE' }}>Phase 3 CP-SAT Optimization Summary</h1>
      ...
      <div className="glass-panel" style={{ padding: '28px', marginBottom: '24px' }}>
        <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#DFE2EE', marginBottom: '16px' }}>Optimization Execution Summary</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px' }}>
          <div style={{ background: '#151E2E', padding: '16px', borderRadius: '8px' }}>
            <div style={{ fontSize: '0.75rem', color: '#64748B' }}>TOTAL GROUPS</div>
            <div style={{ fontSize: '1.5rem', fontWeight: 800, color: '#DFE2EE' }}>{data?.total_groups || 0}</div>
          </div>
          <div style={{ background: '#151E2E', padding: '16px', borderRadius: '8px' }}>
      ...
      <div className="glass-panel" style={{ padding: '24px' }}>
        <h3 style={{ fontSize: '1rem', fontWeight: 700, color: '#DFE2EE', marginBottom: '12px' }}>Raw JSON Response</h3>
